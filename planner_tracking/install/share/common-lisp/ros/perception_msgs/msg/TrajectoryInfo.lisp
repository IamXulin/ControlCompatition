...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TrajectoryInfo>)))
  ...
  "a4d12622c8e266339735f0b7cdd51819")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TrajectoryInfo)))
  "Returns md5sum for a message object of type 'TrajectoryInfo"
  "a4d12622c8e266339735f0b7cdd51819")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TrajectoryInfo>)))
  ...
  (cl:format cl:nil "int32 path_id~%float32 total_path_length~%float32 total_path_time~%int8 decision_type # 5-aeb # 1-destination~%int8 light_type #4-nun 3-double_light 2-turn_left 1-turn_right~%string[] lane_ids~%TrajectoryPoint[] trajectorypoints~%~%================================================================================~%MSG: perception_msgs/TrajectoryPoint~%Point2D position~%float32 velocity~%float32 heading ~%float32 curvature~%float32 s~%float32 t~%float32 a ~%int8 point_type # 轨迹前进和倒退类型，0为前进，1为倒退~%~%================================================================================~%MSG: perception_msgs/Point2D~%float64 x~%float64 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TrajectoryInfo)))
  "Returns full string definition for message of type 'TrajectoryInfo"
  (cl:format cl:nil "int32 path_id~%float32 total_path_length~%float32 total_path_time~%int8 decision_type # 5-aeb # 1-destination~%int8 light_type #4-nun 3-double_light 2-turn_left 1-turn_right~%string[] lane_ids~%TrajectoryPoint[] trajectorypoints~%~%================================================================================~%MSG: perception_msgs/TrajectoryPoint~%Point2D position~%float32 velocity~%float32 heading ~%float32 curvature~%float32 s~%float32 t~%float32 a ~%int8 point_type # 轨迹前进和倒退类型，0为前进，1为倒退~%~%================================================================================~%MSG: perception_msgs/Point2D~%float64 x~%float64 y~%~%~%"))
