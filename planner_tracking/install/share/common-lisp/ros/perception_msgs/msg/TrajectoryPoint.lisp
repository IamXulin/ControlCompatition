...
(cl:defmethod a-val ((m <TrajectoryPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader perception_msgs-msg:a-val is deprecated.  Use perception_msgs-msg:a instead.")
  (a m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TrajectoryPoint>)))
  ...
  "4730bb239196da2dc96ec9550b7d4ef8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TrajectoryPoint)))
  "Returns md5sum for a message object of type 'TrajectoryPoint"
  "4730bb239196da2dc96ec9550b7d4ef8")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TrajectoryPoint>)))
  ...
  (cl:format cl:nil "Point2D position~%float32 velocity~%float32 heading ~%float32 curvature~%float32 s~%float32 t~%float32 a ~%int8 point_type # 轨迹前进和倒退类型，0为前进，1为倒退~%~%================================================================================~%MSG: perception_msgs/Point2D~%float64 x~%float64 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TrajectoryPoint)))
  "Returns full string definition for message of type 'TrajectoryPoint"
  (cl:format cl:nil "Point2D position~%float32 velocity~%float32 heading ~%float32 curvature~%float32 s~%float32 t~%float32 a ~%int8 point_type # 轨迹前进和倒退类型，0为前进，1为倒退~%~%================================================================================~%MSG: perception_msgs/Point2D~%float64 x~%float64 y~%~%~%"))
