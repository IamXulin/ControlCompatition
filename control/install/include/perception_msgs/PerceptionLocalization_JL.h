// Generated by gencpp from file perception_msgs/PerceptionLocalization_JL.msg
// DO NOT EDIT!


#ifndef PERCEPTION_MSGS_MESSAGE_PERCEPTIONLOCALIZATION_JL_H
#define PERCEPTION_MSGS_MESSAGE_PERCEPTIONLOCALIZATION_JL_H
...
struct PerceptionLocalization_JL_
{
  typedef PerceptionLocalization_JL_<ContainerAllocator> Type;

  PerceptionLocalization_JL_()
    : header()
    , frame_unmber(0)
    , fusion_level(0)
    , location_status(0)
  ...
  PerceptionLocalization_JL_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , frame_unmber(0)
    , fusion_level(0)
    , location_status(0)
  ...
  _fusion_level_type fusion_level;
   ...
   typedef int8_t _location_status_type;
  ...
  typedef boost::shared_ptr< ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator> const> ConstPtr;

}; // struct PerceptionLocalization_JL_

typedef ::perception_msgs::PerceptionLocalization_JL_<std::allocator<void> > PerceptionLocalization_JL;

typedef boost::shared_ptr< ::perception_msgs::PerceptionLocalization_JL > PerceptionLocalization_JLPtr;
typedef boost::shared_ptr< ::perception_msgs::PerceptionLocalization_JL const> PerceptionLocalization_JLConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator1> & lhs, const ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.frame_unmber == rhs.frame_unmber &&
    lhs.fusion_level == rhs.fusion_level &&
    lhs.location_status == rhs.location_status &&
...
template <class ContainerAllocator>
struct IsMessage< ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator> >
{
  ...
  static const char* value(const ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x43016e72dce57d38ULL;
  static const uint64_t static_value2 = 0xe9c92344d248c840ULL;
};

template<class ContainerAllocator>
struct DataType< ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::perception_msgs::PerceptionLocalization_JL_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    Printer<int8_t>::stream(s, indent + "  ", v.location_status);
    s << indent << "imu_status: ";
    Printer<int8_t>::stream(s, indent + "  ", v.imu_status);
    s << indent << "roll: ";
...
#endif // PERCEPTION_MSGS_MESSAGE_PERCEPTIONLOCALIZATION_JL_H
