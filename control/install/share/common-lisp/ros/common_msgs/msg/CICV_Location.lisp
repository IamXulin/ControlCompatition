...
(cl:defmethod Roll-val ((m <CICV_Location>))
...
(cl:defmethod Pitch-val ((m <CICV_Location>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CICV_Location>)))
  ...
  "94c0b1b1ab5baa3fecdd722b402b3670")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CICV_Location)))
  "Returns md5sum for a message object of type 'CICV_Location"
  "94c0b1b1ab5baa3fecdd722b402b3670")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CICV_Location>)))
  ...
  (cl:format cl:nil "std_msgs/Header  header~%float64 SimTim~%float64 Position_x   #本车X向坐标~%float64 Position_y   #本车Y向坐标~%float64 Velocity_x   #本车X向车速~%float64 Velocity_y   #本车Y向车速~%float64 Accel_x      #本车纵向加速度~%float64 Accel_y      #本车横向加速度~%float64 Yaw          #本车航向角~%float64 Roll                    # 自车横滚角~%float64 Pitch                   # 自车俯仰角~%float64 Angular_velocity_z    #本车沿Z轴角速度~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CICV_Location)))
  "Returns full string definition for message of type 'CICV_Location"
  (cl:format cl:nil "std_msgs/Header  header~%float64 SimTim~%float64 Position_x   #本车X向坐标~%float64 Position_y   #本车Y向坐标~%float64 Velocity_x   #本车X向车速~%float64 Velocity_y   #本车Y向车速~%float64 Accel_x      #本车纵向加速度~%float64 Accel_y      #本车横向加速度~%float64 Yaw          #本车航向角~%float64 Roll                    # 自车横滚角~%float64 Pitch                   # 自车俯仰角~%float64 Angular_velocity_z    #本车沿Z轴角速度~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
