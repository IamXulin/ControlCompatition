...
(cl:defmethod a_x-val ((m <Perceptionobject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader common_msgs-msg:a_x-val is deprecated.  Use common_msgs-msg:a_x instead.")
  (a_x m))

(cl:ensure-generic-function 'a_y-val :lambda-list '(m))
(cl:defmethod a_y-val ((m <Perceptionobject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader common_msgs-msg:a_y-val is deprecated.  Use common_msgs-msg:a_y instead.")
  (a_y m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Perceptionobject>)))
  ...
  "2b6f12bc3f64a6c0e3dd2f1324ae3c3c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Perceptionobject)))
  "Returns md5sum for a message object of type 'Perceptionobject"
  "2b6f12bc3f64a6c0e3dd2f1324ae3c3c")
