...
(defsystem "diag_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "VehicleAutoFunction" :depends-on ("_package_VehicleAutoFunction"))
    (:file "_package_VehicleAutoFunction" :depends-on ("_package"))
    (:file "VehicleAutoMode" :depends-on ("_package_VehicleAutoMode"))
    (:file "_package_VehicleAutoMode" :depends-on ("_package"))
  ))