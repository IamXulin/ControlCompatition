...
class PerceptionLocalization_JL {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int8(obj.location_status, buffer, bufferOffset);
    // Serialize message field [imu_status]
    bufferOffset = _serializer.int8(obj.imu_status, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new PerceptionLocalization_JL(null);
    ...
    data.location_status = _deserializer.int8(buffer, bufferOffset);
    // Deserialize message field [imu_status]
    data.imu_status = _deserializer.int8(buffer, bufferOffset);
  ...
  static datatype() {
    ...
    return 'perception_msgs/PerceptionLocalization_JL';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '43016e72dce57d38e9c92344d248c840';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PerceptionLocalization_JL(null);
...
module.exports = PerceptionLocalization_JL;
