...
"""autogenerated by genpy from perception_msgs/PolygonStamped.msg. Do not edit."""
import codecs
import sys
...
class PolygonStamped(genpy.Message):
  _md5sum = "2af1629fd1064d1021af937d9d91ec63"
  _type = "perception_msgs/PolygonStamped"
...
"""
  ...
  _slot_types = ['std_msgs/Header','perception_msgs/Polygonbus']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.polygon is None:
        self.polygon = perception_msgs.msg.Polygonbus()
    else:
      self.header = std_msgs.msg.Header()
      self.polygon = perception_msgs.msg.Polygonbus()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = perception_msgs.msg.Point64()
        _x = val1
        start = end
        end += 24
