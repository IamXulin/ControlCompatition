...
"""autogenerated by genpy from perception_msgs/PerceptionLocalization_JL.msg. Do not edit."""
import codecs
import sys
...
class PerceptionLocalization_JL(genpy.Message):
  _md5sum = "43016e72dce57d38e9c92344d248c840"
  _type = "perception_msgs/PerceptionLocalization_JL"
...
string frame_id
"""
  __slots__ = ['header','frame_unmber','fusion_level','location_status','imu_status','roll','pitch','yaw','roll_std','pitch_std','yaw_std','qw','qx','qy','qz','angular_velocity_x','angular_velocity_y','angular_velocity_z','latitude','longitude','altitude','latitude_std','longitude_std','altitude_std','position_x','position_y','position_z','position_x_std','position_y_std','position_z_std','velocity_x','velocity_y','velocity_z','velocity_x_std','velocity_y_std','velocity_z_std','velocity_rx','velocity_ry','velocity_rz','velocity_rx_std','velocity_ry_std','velocity_rz_std','accel_x','accel_y','accel_z']
  _slot_types = ['std_msgs/Header','uint64','int8','int8','int8','float64','float64','float64','float32','float32','float32','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float32','float32','float32','float64','float64','float64','float32','float32','float32','float64','float64','float64','float32','float32','float32','float64','float64','float64','float32','float32','float32','float64','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,frame_unmber,fusion_level,location_status,imu_status,roll,pitch,yaw,roll_std,pitch_std,yaw_std,qw,qx,qy,qz,angular_velocity_x,angular_velocity_y,angular_velocity_z,latitude,longitude,altitude,latitude_std,longitude_std,altitude_std,position_x,position_y,position_z,position_x_std,position_y_std,position_z_std,velocity_x,velocity_y,velocity_z,velocity_x_std,velocity_y_std,velocity_z_std,velocity_rx,velocity_ry,velocity_rz,velocity_rx_std,velocity_ry_std,velocity_rz_std,accel_x,accel_y,accel_z
    ...
    """
    if args or kwds:
      super(PerceptionLocalization_JL, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.frame_unmber, _x.fusion_level, _x.location_status, _x.imu_status, _x.roll, _x.pitch, _x.yaw, _x.roll_std, _x.pitch_std, _x.yaw_std, _x.qw, _x.qx, _x.qy, _x.qz, _x.angular_velocity_x, _x.angular_velocity_y, _x.angular_velocity_z, _x.latitude, _x.longitude, _x.altitude, _x.latitude_std, _x.longitude_std, _x.altitude_std, _x.position_x, _x.position_y, _x.position_z, _x.position_x_std, _x.position_y_std, _x.position_z_std, _x.velocity_x, _x.velocity_y, _x.velocity_z, _x.velocity_x_std, _x.velocity_y_std, _x.velocity_z_std, _x.velocity_rx, _x.velocity_ry, _x.velocity_rz, _x.velocity_rx_std, _x.velocity_ry_std, _x.velocity_rz_std, _x.accel_x, _x.accel_y, _x.accel_z,) = _get_struct_Q3b3d3f10d3f3d3f3d3f3d3f3d().unpack(str[start:end])
      return self
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_Q3b3d3f10d3f3d3f3d3f3d3f3d = None
def _get_struct_Q3b3d3f10d3f3d3f3d3f3d3f3d():
    global _struct_Q3b3d3f10d3f3d3f3d3f3d3f3d
    if _struct_Q3b3d3f10d3f3d3f3d3f3d3f3d is None:
        _struct_Q3b3d3f10d3f3d3f3d3f3d3f3d = struct.Struct("<Q3b3d3f10d3f3d3f3d3f3d3f3d")
    return _struct_Q3b3d3f10d3f3d3f3d3f3d3f3d
